...
: ${AMENT_CURRENT_PREFIX:="/root/dream_ws/install/kr600"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/kr600/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/kr600/environment/path.sh"
