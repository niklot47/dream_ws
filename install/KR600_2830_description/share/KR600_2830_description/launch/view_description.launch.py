...
def generate_launch_description():
    # Define filenames    
    urdf_package = 'KR600_2830_description'
...
# Launch configuration variables specific to simulation
    ...
    # ros2 run robot_state_publisher robot_state_publisher --ros-args -p use_sim_time:=false -p robot_description:="$(xacro path/to/urdf.xacro)"
