...
: ${AMENT_CURRENT_PREFIX:="/root/dream_ws/install/kr600_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/kr600_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/kr600_gazebo/environment/path.sh"
